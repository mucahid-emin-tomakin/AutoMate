...
def main():
    if sys.platform == "win32":
        subprocess.run("title YouTube Downloader", shell=True)
    ...
    # ==================================================
    #  Abschluss (ohne Vollständigkeitsprüfung)
    # ==================================================
    print(f"\n✅ Download abgeschlossen! Die Dateien wurden nach {OUTPUT_DIR} gespeichert.")
